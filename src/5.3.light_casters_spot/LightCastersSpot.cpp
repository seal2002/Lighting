// LightCasterSpot.cpp : Defines the entry point for the console application.
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Light Casters Spot", NULL, NULL);
	...
	// Init my shader
	Shader lightingShader(".\\Resource\\LightCastersSpot.vs", ".\\Resource\\LightCastersSpot.fs");
