// BasicLightingSpecular.cpp : Defines the entry point for the console application.
...
int main()
{
	...
	// Init my shader
	Shader lightingShader(".\\Resource\\LightingSpecular.vs", ".\\Resource\\LightingSpecular.fs");
