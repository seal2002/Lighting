...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lighting Maps Diffuse", NULL, NULL);
	...
	// Init my shader
	Shader lightingShader(".\\Resource\\LightingMapsDiffuse.vs", ".\\Resource\\LightingMapsDiffuse.fs");
